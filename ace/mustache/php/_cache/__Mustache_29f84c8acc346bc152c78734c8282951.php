...
class __Mustache_29f84c8acc346bc152c78734c8282951 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6975055ba90a8c4de1cc57efda2bfad1($context, $indent, $context->findDot('page.conversations'));
        $buffer .= $indent . '</div>';
        $buffer .= "\n";
        $buffer .= $indent . '<!-- /section:pages/dashboard.conversations -->';
        $buffer .= "\n";
