...
class __Mustache_2907a8c502e387664434f057db20ea1f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC0e53ab8bed5c479ad2342f8f5765203($context, $indent, $context->findDot('page.domains1'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
        ...
        $buffer .= $this->sectionAa1c541c421d14bd468c12762d7cc7ae($context, $indent, $context->findDot('page.domains2'));
        $buffer .= $indent . '';
        $buffer .= "\n";
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
